...
import { useDeleteUser, useGetLoggedUser, useUpdateUser, useUpdateUserPassword } from "../api/users/users.endpoints"
...
const Page = () => {
    ...
    const handleDeleteAccount = async () => {
        ...
        if (!response.ok) {
            ...
            console.error("Error deleting account:", errorData.error || "Unknown error");
        }
        setNewEmail("");
        setNewPassword("");
        redirect("/login");
